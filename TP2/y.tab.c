...
{
       0,    23,    23,    27,    28,    31,    35,    38,    42,    43,
      46,    49,    50,    53,    61,    74,    89,    90,    94,    95,
      98,    99,   100,   101,   102,   103,   104,   105,   108,   109,
     110,   111,   112,   113,   114,   117,   118,   119,   120,   123,
...
static const char *const yytname[] =
{
  ...
  "PRINT", "RETURN", "FUNCAO", "VAR", "VALOR", "DESIGNACAO", "STRING",
  "'('", "')'", "'{'", "'}'", "';'", "','", "'['", "']'", "'='", "'>'",
  "'<'", "'!'", "'+'", "'-'", "'|'", "'*'", "'/'", "'%'", "'&'", "$accept",
...
{
     -44,     2,    14,   -44,    23,    18,   -44,   -44,   -44,    26,
      37,    43,    39,   -44,     5,    49,    28,    51,    48,    73,
      74,    84,    31,    -5,   -44,   -44,    75,   -44,    92,   105,
     -44,   -44,    39,   105,   105,    98,   106,   -44,     0,   107,
     105,    36,    70,   -44,   -44,   108,   115,   105,    37,   109,
      55,   -44,   112,    83,   113,   -44,   114,   -44,   116,   -44,
     105,   105,   105,   105,   105,   105,   105,   117,   111,    52,
      86,   118,   120,   119,    -9,     7,   121,   123,   -44,   -44,
      70,    70,    70,   -44,   -44,   -44,   -44,   -44,   122,   -44,
     105,   127,   126,   -44,   105,   105,    55,   105,    55,   105,
     -44,   129,    58,   -44,   124,    21,    55,    55,    55,    55,
      29,   125,   -44,   -44,   130,   -44,   -44,   131,   -44,    54,
     -44
};
...
{
     -44,   -44,   -44,   -44,   -44,   -44,   128,   -44,   102,   -44,
     -44,   -43,   -44,    -2,   -21,    61,    50,   -14
};
...
static const yytype_uint8 yytable[] =
{
      ...
      45,    20,    21,    22,    95,    56,    46,     4,    23,    37,
      38,    46,    40,    24,     5,    19,    69,    20,    21,    22,
      97,     9,    54,    19,    23,    20,    21,    22,    58,   114,
       8,    11,    23,    37,    38,    39,    40,   115,    12,    28,
     105,    29,    16,    96,    98,    59,    26,   110,    19,    15,
      20,    21,    22,    60,    61,    62,    27,    23,    32,   102,
      31,    89,   120,   106,   107,   119,   108,   112,   109,    60,
      61,    62,    60,    61,    62,    60,    61,    62,    33,    34,
      19,    26,    20,    21,    22,    90,    26,    35,    47,    23,
      63,    64,    65,    66,    49,    26,    73,    74,    75,    76,
      60,    61,    62,    83,    84,    85,    86,    37,    38,    46,
      40,    80,    81,    82,    67,    55,    57,    68,    72,    77,
      78,    71,    79,    88,    51,   117,    87,    93,   104,    92,
     100,   111,    94,   101,    99,   103,   113,   116,   118,     0,
       0,     0,     0,     0,     0,    48
};
...
static const yytype_int8 yycheck[] =
{
      ...
      15,     6,     7,     8,    23,    15,    21,     3,    13,    12,
      13,    21,    15,    18,    10,     4,    47,     6,     7,     8,
      23,    13,    34,     4,    13,     6,     7,     8,    40,    18,
      17,    15,    13,    12,    13,    14,    15,    18,    11,    21,
      93,    23,    13,    74,    75,    19,    70,   100,     4,    16,
       6,     7,     8,    27,    28,    29,    17,    13,    20,    90,
      19,    19,    18,    94,    95,   118,    97,    19,    99,    27,
      28,    29,    27,    28,    29,    27,    28,    29,    15,    15,
       4,   105,     6,     7,     8,     9,   110,    13,    23,    13,
      30,    31,    32,    33,    12,   119,    23,    24,    25,    26,
      27,    28,    29,    63,    64,    65,    66,    12,    13,    21,
      15,    60,    61,    62,    16,    19,    19,    12,    16,    16,
      16,    22,    16,    22,    32,     5,    19,    17,    12,    21,
      17,    12,    23,    21,    23,    18,    22,    22,    17,    -1,
      -1,    -1,    -1,    -1,    -1,    27
};
...
#line 53 "compilador.y"
    {	if (g_tree_lookup(designacoes, (yyvsp[(1) - (2)].valString)) != NULL) {
																...
																g_tree_insert(designacoes, (yyvsp[(1) - (2)].valString), NULL);
...
#line 61 "compilador.y"
    {	if (g_tree_lookup(designacoes, (yyvsp[(1) - (4)].valString)) != NULL) {
																...
																if (atoi((yyvsp[(3) - (4)].valString)) < 1) {
																	...
																	g_tree_insert(designacoes, (yyvsp[(1) - (4)].valString), NULL);
...
#line 74 "compilador.y"
    {	if (g_tree_lookup(designacoes, (yyvsp[(1) - (7)].valString)) != NULL) {
																...
																if (atoi((yyvsp[(3) - (7)].valString)) < 1 || atoi((yyvsp[(6) - (7)].valString)) < 1) {
																	...
																	g_tree_insert(designacoes, (yyvsp[(1) - (7)].valString), NULL);
